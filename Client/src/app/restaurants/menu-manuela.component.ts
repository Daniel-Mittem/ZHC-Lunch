...
import { MenuService } from '../services/manuela.service';
import { ReservationService } from '../services/reservation.service';
import { ToastIngredient } from '../../model/menu.model';

@Component({
  selector: 'app-menu-manuela',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class MenuManuelaComponent implements OnInit, OnDestroy {
  restaurantName = 'Bar Manuela';
