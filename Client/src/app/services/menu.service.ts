...
export class MenuService {
  ...
  private firstCoursesData: MenuItem[] = [
    { id: 1, name: 'Tortellini panna e prosciutto', category: 'primi', quantity: 0, price: 9.00 },
    { id: 2, name: 'Lasagne alla bolognese', category: 'primi', quantity: 0, price: 9.00 },
    { id: 3, name: 'Tonnarelli cacio e pepe', category: 'primi', quantity: 0, price: 9.00 },
    { id: 4, name: 'Spaghetti alla carbonara', category: 'primi', quantity: 0, price: 9.00 },
    { id: 5, name: 'Garganelli gamberi e zucchine', category: 'primi', quantity: 0, price: 9.00 },
    { id: 6, name: 'Fusilli alla matriciana', category: 'primi', quantity: 0, price: 9.00 },
    { id: 7, name: 'Penne all arrabbiata', category: 'primi', quantity: 0, price: 9.00 },
    { id: 8, name: 'Risotto alla milanese', category: 'primi', quantity: 0, price: 9.00 },
    { id: 9, name: 'Risotto ai funghi', category: 'primi', quantity: 0, price: 9.00 },
    { id: 10, name: 'Risotto provola e radicchio', category: 'primi', quantity: 0, price: 9.00 },
    { id: 11, name: 'Risotto agli asparagi', category: 'primi', quantity: 0, price: 9.00 },
  ];
